import { GreenCarbonForm } from "@/components/forms/green-carbon-form"
import { Card } from "@/components/ui/card"
import { CheckCircle2 } from "lucide-react"

export const metadata = {
  title: "Create Green Carbon Project - Athlas Verity",
  description: "Start a new green carbon verification project",
}

export default function CreateGreenCarbonPage() {
  return (
