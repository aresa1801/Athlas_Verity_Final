        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <Card className="border-border/50 bg-card/50 p-6 h-full overflow-hidden">
              ...
              <div className="h-96 rounded-lg overflow-hidden border border-border/30 bg-card/50 flex items-center justify-center">
                <p className="text-muted-foreground">Map interface is under maintenance. Polygon data is available from satellite file uploads.</p>
              </div>
              {polygon.length > 0 && (
